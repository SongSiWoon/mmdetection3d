...
data_root = ''
ann_file_prefix = 'data/wildscenes/wildscenes_opt3d/'
...
train_dataloader = dict(
    ...
    dataset=dict(
        type=dataset_type,
        data_root=data_root,
        ann_file=ann_file_prefix + 'wildscenes_infos_train.pkl',
...
val_dataloader = dict(
    ...
    dataset=dict(
        type=dataset_type,
        data_root=data_root,
        ann_file=ann_file_prefix + 'wildscenes_infos_val.pkl',
...
test_dataloader = dict(
    ...
    dataset=dict(
        type=dataset_type,
        data_root=data_root,
        ann_file=ann_file_prefix + 'wildscenes_infos_test.pkl',
        pipeline=test_pipeline,
        metainfo=metainfo,
        modality=input_modality,
        ignore_index=255,
